...
`), A++, O = e, k = 14;
  ...
  return { setPosition: V, getPosition: () => e, scan: l ? E : w, getToken: () => k, getTokenValue: () => u, getTokenOffset: () => p, getTokenLength: () => e - p, getTokenStartLine: () => o, getTokenStartCharacter: () => p - B, getTokenError: () => b };
}
function J(n) {
  return n === 32 || n === 9;
}
...
//# sourceMappingURL=chunk-E7SPQ3MG.js.map