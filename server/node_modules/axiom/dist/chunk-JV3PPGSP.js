...
import { statSync as statSync2, promises as promises2 } from "fs";
...
async function readPackageJSON(id, options = {}) {
  ...
  const blob = await promises2.readFile(resolvedPath, "utf8");
  let parsed;
  try {
    parsed = x(blob);
  } catch {
...
//# sourceMappingURL=chunk-JV3PPGSP.js.map